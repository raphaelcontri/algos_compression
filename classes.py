...
class Tas :
    ...
    def fusion(self, other) :
        if isinstance(self, Empty) :
            ...
            if self.val.val[1] < other.val.val[1] :
    ...
    def estTas(self) :
        ...
        if not isinstance(self.gauche, Empty) and isinstance(self.droite, Empty) :
            if self.gauche.val[2] < self.val[2] :
